...
public class UserDAO {
	...
	public static boolean save(User user) throws PersistentException {
		try {
			ProjectPersistentManager.instance().saveObject(user);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(User user) throws PersistentException {
		try {
			ProjectPersistentManager.instance().deleteObject(user);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean deleteAndDissociate(User user)throws PersistentException {
		try {
			if (user.getPortfolio() != null) {
				user.getPortfolio().setUser(null);
			}
	...
	public static boolean refresh(User user) throws PersistentException {
		try {
			ProjectPersistentManager.instance().getSession().refresh(user);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(User user) throws PersistentException {
		try {
			ProjectPersistentManager.instance().getSession().evict(user);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
